...
import grubPaeApp from "@/public/assets/images/png/grubPaeApp.png";
...
const RestInfo = () => {
  ...
  const sideCards = [
    {
      image: grubPaeApp,
      heading: t("how_GRUB-PAE_works"),
      subHeading: t("how_GRUB-PAE_works_desc"),
      right: false
    },
    {
  ...
  return (
    <div className='w-screen h-auto'>
      <Heading
        heading={t("reach_more_customers_and_grow_your_business_with_GRUB-PAE")}
        subHeading={t("partner_with_GRUB-PAE_to_create_more_sales")}
      />
      <StartingImage image={restaurantBanner} />
      <WhyChoose
        heading={t("why_deliver_with_GRUB-PAE")}
