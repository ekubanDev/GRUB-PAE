export const ar = {
  ...
  welcome:
    'مرحبًا بك في Yalla، في بعض الأحيان كل ما تحتاجه هو الحب. ولكن القليل من الطعام بين الحين والآخر لا يضر.',
  welcomeScreen: 'مرحبا بكم في يلا',
  ...
  createAccountFirst: 'أنشئ حسابك في إنتجا',
  ...
  otpSentToEmail: 'ادخل رمز OTP للتحقق من بريدك الإلكتروني بأمان. خصوصيتك أمر بالغ الأهمية؛ بياناتك محمية دائمًا.',
  ...
  yourPhoneNumber: "أدخل رقم الهاتف",
secureAccountWithPhone: 'سنستخدم رقمك فقط إذا كنا بحاجة للاتصال بك بشأن طلبك. بعد ذلك، سنرسل لك رمزًا عبر الرسائل النصية للتأكد من أننا حصلنا على الرقم الصحيح.',
  Home: 'المنزل',
  Work: 'العمل',
  Other: 'آخر',
  Apartment: 'شقة',
  ...
  pendingOrder: "تم استلام الطلب! نحن الآن في انتظار قبول المتجر لطلبك. سيتم إعلامك بمجرد تأكيد ذلك",
  acceptedOrder: 'تحضير طعامك. سيتم تسليمها قريبا جدا.',
  assignedOrder: 'تحضير طعامك. سيتم تسليمها قريبا جدا.',
  ...
  min: 'دقيقة',
  Closed: 'مغلق',
  PenddingText: "نحن الآن في انتظار قبول المتجر لطلبك.",
  ...
  receiveOfferByEmail: 'أرغب في تلقي عروض خاصة وترويجات منا عبر البريد الإلكتروني',
  receivePushNotification: 'أرغب في تلقي عروض خاصة وترويجات منا عبر الإشعارات',
  ...
  enterOtp: 'أدخل رمز OTP للتحقق من رقم هاتفك بأمان. خصوصيتك أمر بالغ الأهمية؛ بياناتك محمية دائمًا.',
  ...
  contact: 'اتصال',
  viewWebsite: 'عرض الموقع الإلكتروني',
  website: 'موقع الويب',
  restaurant: 'مطعم',
  deliveryCost: 'تكلفة التوصيل',
  restrictionsInstructions:
    'إذا كان لديك حساسية أو قيود غذائية أخرى، يرجى الاتصال بالمطعم. سيقدم المطعم معلومات خاصة بالطعام حسب الطلب.',
  preservationText: 'يتم الحفاظ على الطعم الأصلي لجميع الأطعمة التقليدية هنا.',
  none: 'لا شي',
  yourEmail: 'قم بتسجيل الدخول بسهولة عن طريق إدخال بريدك الإلكتروني!',
  yourEmailPassword: 'يرجى إدخال كلمات مرورك الآن للوصول!',
  brandName: 'إيناتيجا',
  welcomeText: 'مرحبًا بك في إيناتيجا',
  createAccountDesc:
    'استمتع بأفضل المطاعم أو احصل على ما تحتاجه من المتاجر القريبة، واحصل عليه مسلماً!',
...
BrowseCuisines: 'تصفّح أنواع المأكولات',
"Popular right now": "شعبي الآن",
"I feel like eating": "أشعر برغبة في الأكل",
"I feel like eating...": "أشعر برغبة في الأكل...",
"Restaurants near you": "المطاعم بالقرب منك",
"Fresh finds await...": "تنتظرك العثورات الطازجة...",
"Grocery List": "قائمة البقالة",
"Top grocery picks": "أفضل اختيارات البقالة",
"Top Grocery Brands": "أهم علامات البقالة",
"Top Restaurant Brands": "أهم علامات المطعم",
"Our brands": "علاماتنا",
Restaurants: "مطاعم",
Stores: "متاجر",
"Lets shop for": "لنتسوق لـ",
"Collections": "مجموعات",
"All Stores": "جميع المتاجر",
"Order Again": "أعد الطلب",
"Top Picks": "الاختيارات الأعلى",
"Top Brands": "أفضل العلامات التجارية",
"All Grocery": "جميع المواد الغذائية",
"All Restaurant": "جميع المطاعم",
"From your previous orders": "من طلباتك السابقة",
...
'PaymentNotSuccessfull': 'الدفع غير ناجح',
  ...
  Delivery: 'التوصيل',
  Pickup: 'الاستلام',
  "AddMessageforRestaurant": "أضف رسالة للمطعم",
  "specialRequest": "طلبات خاصة، الحساسية، القيود الغذائية",
  "Done": "تم",
  "addMessage": "أضف رسالة",
  "kindlyBeAdvisedText": "يرجى العلم بأن رسالتك قد تكون مرئية أيضًا لشريك التوصيل المسؤول عن تسليم طلبك إلى المكان.",
  exploreYallaCities: 'استكشاف مدن يالا',
  Card: 'بطاقة',
  lebelAlreadyExist: "التسمية '{{selectedLabel}}' موجودة بالفعل. يرجى اختيار تسمية مختلفة.",
  UpdateAvailable: "تحديث متاح",
  UpdateAvailableText: "نسخة جديدة من التطبيق متاحة. يرجى التحديث للاستمرار في استخدام التطبيق.",
  ...
  "Can't deliver to this address": "لا يمكن التوصيل إلى هذا العنوان",
"This restaurant doesn’t deliver to your location. Please explore restaurants available in your delivery area": "المطعم لا يقدم خدمة التوصيل إلى العنوان الذي اخترته حاليًا. يرجى استكشاف المطاعم المتوفرة في منطقة التوصيل الخاصة بك",
