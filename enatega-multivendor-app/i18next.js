...
const detectAndSetLanguage = async () => {
  try {
    const storedLanguage = await AsyncStorage.getItem('grubpae-language');
    ...
    await AsyncStorage.removeItem('grubpae-language');
    await AsyncStorage.removeItem('grubpae-language-name');
  } catch (error) {
